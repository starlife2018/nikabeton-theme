		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'_service_icon'  => 'Послуга - Іконка (Emoji/SVG)',
					'_portfolio_location' => 'Портфоліо - Локація',
					'_portfolio_volume'   => 'Портфоліо - Об\'єм',
					'_review_rating' => 'Відгук - Оцінка (1-5)',
					'_review_source' => 'Відгук - Джерело (Google/Facebook...)',
					'_zone_address'  => 'Зона - Адреса',
					'_zone_map_iframe' => 'Зона - Карта (iframe)',
					'_product_price' => 'Товар (ЗБВ) - Ціна',
					'_product_application' => 'Товар (ЗБВ) - Застосування',
				],
